...
photoFrame = Frame(FrameSelectionWindowFunny)
photoFrame.grid(column=0, row=1, columnspan=2, pady=10)
...
for x in range(1, len(tempNumber)):
    if(columnCount == 8):
        columnCount = 0
        rowCount = rowCount + 1
    ...
    tkimage = ImageTk.PhotoImage(resized)
    myvar = Label(photoFrame, image=tkimage)
    myvar.image = tkimage
